  ...
  return (
    <div className="min-h-screen py-6 sm:py-12 px-4">
      <div className="bg-white p-6 md:p-10 rounded shadow-md max-w-auto mx-auto"><div className="max-w-7xl mx-auto">
        ...
        <div>
          <Subheading className="text-blue-700">Staff Performance</Subheading>          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {staffPerformance.map((staff, index) => (
              <div key={index} className="p-6 bg-white rounded-lg shadow-md border border-gray-200">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${staff.activelyAssigned ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                    {staff.activelyAssigned ? 'Yes' : 'No'}
                  </span>
                </div>
                <div className="mt-3 pt-3 border-t border-gray-200">
                  <Text color="text-gray-500" size="xs">Total tickets: <span className="font-medium">{staff.assigned}</span> assigned / <span className="font-medium">{staff.resolved}</span> resolved</Text>
                </div>
              </div>
            ))}</div>
      </div>
