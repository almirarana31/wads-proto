        ...
        routes: [
          {
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/api/conversations', '321'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/user-guide/', '0b6'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/user-guide/admin',
                component: ComponentCreator('/docs/user-guide/admin', 'd8f'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/user-guide/customer',
                component: ComponentCreator('/docs/user-guide/customer', '30f'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/user-guide/staff',
                component: ComponentCreator('/docs/user-guide/staff', 'd4f'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
